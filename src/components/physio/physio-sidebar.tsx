...
export function PhysioSidebar({ physioId }: PhysioSidebarProps) {
  ...
  return (
    <>
      <div className="sticky top-0 z-40 border-b border-[hsl(var(--kinetic-wine)/0.1)] bg-[hsl(355_35%_98%)] md:hidden">
        ...
        <nav className="flex gap-2 overflow-x-auto border-t border-[hsl(var(--kinetic-wine)/0.08)] px-4 py-2">
          {navItems.map((item) => {
            ...
            return (
              <Link
                ...
                className={cn(
                  ...
                  active
                    ? "border-[hsl(var(--kinetic-wine))] bg-[hsl(var(--kinetic-wine)/0.12)] text-[hsl(var(--kinetic-wine))]"
                    : "border-[hsl(var(--kinetic-wine)/0.2)] bg-white text-slate-600"
                )}
              >
                {item.label}
              </Link>
      ...
      <aside className="fixed left-0 top-0 z-40 hidden h-screen w-64 border-r border-[hsl(var(--kinetic-wine)/0.1)] bg-[hsl(355_35%_98%)] md:block">
